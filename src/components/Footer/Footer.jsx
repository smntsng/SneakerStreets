        ...
        <div className= "main-footer">
            <div className= "container " style={{ width: '100%', margin: '0 auto', maxWidth: '1400px' }}>
                ...
                <div className= "socials">
                    <div className='socialIcon'> <FontAwesomeIcon icon={faFacebook} /></div>
                    <div className='socialIcon'> <FontAwesomeIcon icon={faTwitter}  /></div>
                    <div className='socialIcon'> <FontAwesomeIcon icon={faTiktok} /></div>
                    <div className='socialIcon'> <FontAwesomeIcon icon={faInstagram} /></div>
                </div>
            </div>
            </div>
